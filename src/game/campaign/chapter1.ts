  ...
  nodes: [
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        energyCost: 5,
        objectives: [],
        firstClearReward: { label: 'Bone Soldier', sub: 'First look at the Undead roster', icon: 'card' },
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Grave Knight', sub: 'New card revealed', icon: 'card' },
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Cursed Warrior', sub: 'New card revealed', icon: 'card' },
        repeatReward: { label: '2 embers', sub: 'Every clear after the first', icon: 'ember' },
      }),
    },
    {
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Dark Priest', sub: 'New card revealed', icon: 'card' },
        repeatReward: { label: '2 embers', sub: 'Every clear after the first', icon: 'ember' },
      }),
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Mira', sub: 'New card revealed', icon: 'card' },
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Vharos', sub: 'New card + chapter seal', icon: 'card' },
