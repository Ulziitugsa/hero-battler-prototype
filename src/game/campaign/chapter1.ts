  ...
  nodes: [
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        energyCost: 5,
        objectives: [],
        firstClearReward: { label: 'Bone Soldier', sub: 'First look at the Undead roster', icon: 'card', cardId: 'und-bone-soldier' },
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Grave Knight', sub: 'New card revealed', icon: 'card', cardId: 'und-grave-knight' },
    ...
    },
    {
      ...
      reward: { label: '2 embers', sub: 'A cairn left by an earlier traveller', icon: 'ember' },
    },
    {
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Kingdom emblem', sub: 'Profile emblem, chapter 1', icon: 'emblem' },
        repeatReward: { label: '1 ember', sub: 'Every clear after the first', icon: 'ember' },
      }),
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Cursed Warrior', sub: 'New card revealed', icon: 'card', cardId: 'und-cursed-warrior' },
        repeatReward: { label: '2 embers', sub: 'Every clear after the first', icon: 'ember' },
      }),
    },
    {
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Dark Priest', sub: 'New card revealed', icon: 'card', cardId: 'und-dark-priest' },
        repeatReward: { label: '2 embers', sub: 'Every clear after the first', icon: 'ember' },
      }),
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Mira', sub: 'New card revealed', icon: 'card', cardId: 'und-mira' },
    ...
    },
    {
      ...
      encounter: UNDEAD_ENCOUNTER({
        ...
        firstClearReward: { label: 'Vharos', sub: 'New card + chapter seal', icon: 'card', cardId: 'und-vharos' },
